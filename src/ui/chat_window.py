...
class ChatWindow(QWidget):
    ...
    def toggle(self) -> None:
        if self.isVisible():
            ...
            # self.load_history()  # disabled — no local persistence
            self.show()
    ...
    def _send_message(self) -> None:
        ...
        self.scroll_layout.addWidget(bubble, 0, Qt.AlignRight)
        
        self.message_sent.emit(text)
        
        # Prepare AI Bubble
        self._current_ai_bubble = MessageBubble("assistant", "", self._get_timestamp(), self)
        self.scroll_layout.addWidget(self._current_ai_bubble, 0, Qt.AlignLeft)
        
        QTimer.singleShot(0, self._scroll_to_bottom)
        
        # Save to history (disabled — user opted out of local persistence)
    ...
    def load_history(self) -> None:
        ...
        # P2: Only reload if file changed since last load
        try:
        ...
        for i in reversed(range(self.scroll_layout.count())):
            ...
            widget_to_remove = item.widget() if item else None
        ...
        try:
            ...
            for msg in history[-50:]:
                ...
                if role == "user":
                    ...
                    self.scroll_layout.addWidget(bubble, 0, Qt.AlignLeft)
