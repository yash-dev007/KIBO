...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/zephyrus/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/zephyrus/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Zephyrus's existing visual language. Specifically:
